          ...
          <tbody>
            {jobsApplied.map((job, index) => true? (
              <tr>
                ...
                <td className='py-2 px-4 border-b'>
                  <span className={`${job.status === 'Pending' ? 'bg-yellow-100 text-yellow-600' : job.status === 'Accepted' ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600'} px-4 py-1.5 rounded-full text-sm`}>
                    {job.status}
                  </span>
                </td>
              </tr>
